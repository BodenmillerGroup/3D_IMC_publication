...
data_dir_base = '~/3D_hypoxia_model201709/' #make sure to end with '/' for string concatenation
...
stack3d_order = data_dir_base + 'final_3D_stack_order_hypoxia_model201709.csv'
